...
angular.module('app').service('StockService', ['$http', '$q', function($http, $q) {
    ...
    return {
      getCompanyDate: function(name) {
        var url = domain +
          encodeURI("select * from yahoo.finance.historicaldata where symbol in('" + name +
...
angular.module('app').controller('myController', ['StockService', function(StockService) {
    var model = this;
    var companyNames = [];
    var company = {};
